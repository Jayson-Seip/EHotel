...
<%
    boolean error = false;
    if ("problemInsert".equals(request.getParameter("problemForm"))){
        int roomID = Integer.parseInt(request.getParameter("roomID"));
        String problem = request.getParameter("problem");
        RoomService rs = new RoomService();
        try{
            rs.insertProblem(roomID,problem);
...
<%}%>
<form id="problemInsert" action="insert-room-problem.jsp" method="post">
    <input type ="hidden" name="problemForm" value="problemInsert">
